...
function initial(){
	...
	if(sw_mode != "1"){
		...
		if(sw_mode == 2 || sw_mode == 4){
			...
			if(wlc_band == 0 || wlc_band == -1)		//-1 is for default
				...
				<tr>
					<td id="clients_td" width="150" bgcolor="#444f53" align="center" valign="top" class="NM_radius" style="padding-bottom:15px;">
						...
						<!--div onclick="">
							...
							<a href="device-map/clients.asp" target="statusframe">
							<div id="iconClient" style="margin-top:20px;" onclick=""></div>
							</a>
							<div class="clients" style="cursor:pointer;">Wireless Clients:</div>
						</div-->
					</td>
